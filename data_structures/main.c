...
void main()
{
			...
			initQueue(test2,0,ROUND_ROBIN);
			initQueue(test3,1,ROUND_ROBIN);
			initQueue(test4,2,ROUND_ROBIN);
			initQueue(test5,0,ROUND_ROBIN);
			initQueue(test6,0,ROUND_ROBIN);
			initQueue(test7,0,ROUND_ROBIN);
